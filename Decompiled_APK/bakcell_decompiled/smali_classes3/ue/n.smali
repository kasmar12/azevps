...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lue/n;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lue/n;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
...
.method public constructor <init>(IZ)V
    ...
    iput p2, p0, Lue/n;->c:I

    new-instance v0, Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-direct {v0, p1}, Ljava/util/concurrent/atomic/AtomicReferenceArray;-><init>(I)V

    iput-object v0, p0, Lue/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final a(Ljava/lang/Runnable;)I
    ...
    :cond_0
    sget-object v6, Lue/n;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    :cond_3
    iget-object v12, p0, Lue/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-boolean v4, p0, Lue/n;->b:Z
    ...
    iget-object v1, v0, Lue/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v2, v0, Lue/n;->c:I
    ...
    instance-of v4, v3, Lue/m;

    if-eqz v4, :cond_7

    check-cast v3, Lue/m;

    iget v3, v3, Lue/m;->a:I
...
.method public final b()Z
    ...
    :cond_0
    sget-object v0, Lue/n;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
...
.method public final c()Lue/n;
    ...
    :goto_0
    sget-object v0, Lue/n;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    iget v4, p0, Lue/n;->a:I

    mul-int/lit8 v4, v4, 0x2

    iget-boolean v5, p0, Lue/n;->b:Z

    invoke-direct {v1, v4, v5}, Lue/n;-><init>(IZ)V
    ...
    iget-object v7, p0, Lue/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    new-instance v7, Lue/m;

    invoke-direct {v7, v4}, Lue/m;-><init>(I)V

    :cond_3
    iget-object v8, v1, Lue/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v9, v1, Lue/n;->c:I
...
.method public final d()Ljava/lang/Object;
    ...
    :cond_2
    iget-object v15, v6, Lue/n;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-virtual {v15, v13}, Ljava/util/concurrent/atomic/AtomicReferenceArray;->get(I)Ljava/lang/Object;

    move-result-object v4

    iget-boolean v5, v6, Lue/n;->b:Z
    ...
    :cond_6
    sget-object v1, Lue/n;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
