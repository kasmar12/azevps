...
# instance fields
.field private final resultTaskCompletionSource:Lkb/m;
...
# direct methods
.method public constructor <init>(Lcom/google/firebase/installations/Utils;Lkb/m;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lcom/google/firebase/installations/GetAuthTokenListener;->resultTaskCompletionSource:Lkb/m;
...
.method public onException(Ljava/lang/Exception;)Z
    ...
    iget-object v0, p0, Lcom/google/firebase/installations/GetAuthTokenListener;->resultTaskCompletionSource:Lkb/m;
...
.method public onStateReached(Lcom/google/firebase/installations/local/PersistedInstallationEntry;)Z
    ...
    invoke-virtual {v0, p1}, Lkb/m;->b(Ljava/lang/Object;)V
