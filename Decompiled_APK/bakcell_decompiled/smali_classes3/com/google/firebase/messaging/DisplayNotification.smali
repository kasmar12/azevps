...
.method private showNotification(Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;)V
    ...
    iget-object p1, p1, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;->notificationBuilder:Lw0/r;

    invoke-virtual {p1}, Lw0/r;->a()Landroid/app/Notification;
...
.method private waitForAndApplyImageDownload(Lw0/r;Lcom/google/firebase/messaging/ImageDownload;)V
    .locals 6
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p2}, Lcom/google/firebase/messaging/ImageDownload;->getTask()Lkb/l;
    ...
    invoke-static {v1, v3, v4, v2}, LWa/A3;->b(Lkb/l;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/graphics/Bitmap;

    invoke-virtual {p1, v1}, Lw0/r;->d(Landroid/graphics/Bitmap;)V
    ...
    :goto_0
    iput-object v5, v2, Lw0/o;->c:Landroidx/core/graphics/drawable/IconCompat;

    iput-object v4, v2, Lw0/o;->d:Landroidx/core/graphics/drawable/IconCompat;

    iput-boolean v3, v2, Lw0/o;->e:Z

    invoke-virtual {p1, v2}, Lw0/r;->e(LC9/e;)V
    :try_end_0
...
.method public handleNotification()Z
    ...
    iget-object v3, v2, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;->notificationBuilder:Lw0/r;

    invoke-direct {p0, v3, v0}, Lcom/google/firebase/messaging/DisplayNotification;->waitForAndApplyImageDownload(Lw0/r;Lcom/google/firebase/messaging/ImageDownload;)V
