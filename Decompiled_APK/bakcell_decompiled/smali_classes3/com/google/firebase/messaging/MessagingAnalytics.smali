...
.method public static getInstanceId(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/firebase/installations/FirebaseInstallations;->getId()Lkb/l;

    move-result-object p0

    invoke-static {p0}, LWa/A3;->a(Lkb/l;)Ljava/lang/Object;
...
.method public static getProjectNumber(Landroid/os/Bundle;)J
    ...
    sget-object v1, Lz5/RJJ/WmYAKPMRDwlRG;->nrncIxcPBHwnqS:Ljava/lang/String;
...
.method public static logNotificationReceived(Landroid/content/Intent;)V
    ...
    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->getTransportFactory()Lg9/g;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lcom/google/firebase/messaging/MessagingAnalytics;->logToFirelog(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;Lg9/g;)V

    :cond_1
    return-void
.end method

.method private static logToFirelog(Lcom/google/firebase/messaging/reporting/MessagingClientEvent$Event;Landroid/content/Intent;Lg9/g;)V
    .locals 5
    ...
    invoke-direct {v1, p1}, Lg9/b;-><init>(Ljava/lang/Integer;)V
    ...
    invoke-direct {v3, v2}, Lg9/c;-><init>(Ljava/lang/String;)V

    new-instance v2, Lcom/google/firebase/messaging/l;

    const/4 v4, 0x0

    invoke-direct {v2, v4}, Lcom/google/firebase/messaging/l;-><init>(I)V

    check-cast p2, Lj9/o;

    invoke-virtual {p2, p1, v3, v2}, Lj9/o;->a(Ljava/lang/String;Lg9/c;Lg9/e;)Lj9/p;
    ...
    invoke-direct {p2, p0, v2, v1}, Lg9/a;-><init>(Ljava/lang/Object;Lg9/d;Lg9/b;)V

    new-instance p0, Lcom/google/firebase/messaging/l;

    const/16 v1, 0xe

    invoke-direct {p0, v1}, Lcom/google/firebase/messaging/l;-><init>(I)V

    invoke-virtual {p1, p2, p0}, Lj9/p;->a(Lg9/a;Lg9/h;)V
    :try_end_0
