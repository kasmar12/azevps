...
.method public constructor <init>(Landroid/widget/EditText;)V
    ...
    invoke-direct {v0, p1}, LU/M;-><init>(Landroid/widget/EditText;)V
...
.method public a(Landroid/text/method/KeyListener;)Landroid/text/method/KeyListener;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/B;->c:Ljava/lang/Object;
...
.method public b(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/B;->d(Z)V
    ...
    invoke-static {v1, p1, v2, p2}, LS1/m;->L(Landroid/content/Context;Landroid/util/AttributeSet;[II)LS1/m;

    move-result-object p1

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, LS1/m;->y(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v7, v2}, Landroidx/appcompat/widget/B;->e(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-virtual {p1, v2}, LS1/m;->y(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_4

    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/widget/B;->e(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public c(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)LZ0/b;
    .locals 2
    ...
    invoke-direct {v1, v0, p1, p2}, LZ0/b;-><init>(Landroid/widget/EditText;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)V
...
.method public d(Z)V
    ...
    iget-boolean v1, v0, LZ0/i;->c:Z

    if-eq v1, p1, :cond_1

    iget-object v1, v0, LZ0/i;->b:LZ0/h;
    ...
    iget-object v2, v0, LZ0/i;->b:LZ0/h;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v3, "initCallback cannot be null"

    invoke-static {v2, v3}, LVa/q4;->e(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v3, v1, LX0/j;->a:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    :try_start_0
    iget-object v1, v1, LX0/j;->b:Lj0/f;

    invoke-virtual {v1, v2}, Lj0/f;->remove(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v0, v0, LZ0/i;->a:Landroid/widget/EditText;

    invoke-static {v0, p1}, LZ0/i;->a(Landroid/widget/EditText;I)V
...
.method public e(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Landroidx/appcompat/widget/B;->e(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
