...
SUPPORTED_LANGUAGES = {
    ...
    'en': {
        ...
        'welcome': '🎭 **Fake Email Bot**\n\nWelcome to the 10-minute fake email creator!\n\n📧 Type /create to generate a new email',
        'help': '🎭 **Help:**\n\n/create - Create new email\n/check - Check emails\n/inbox - Show inbox\n/clear - Delete emails\n/domains - Show domains\n/settings - Settings',
        'email_created': '✅ **Email Created!**\n\n📧 Email: `{email}`\n⏰ Duration: 10 minutes\n\n📨 Type /check to receive emails',
        'no_emails': '📭 No emails in your inbox',
        'email_received': '📨 **New Email!**\n\n👤 From: `{sender}`\n📧 Subject: `{subject}`\n⏰ Time: `{time}`\n\n📝 Type /read {id} to see content',
    ...
    'tr': {
        'name': 'tr',
        'display_name': 'Türkçe',
        'welcome': '🎭 **Fake Email Bot**\n\n10 dakikalık sahte email oluşturucuya hoş geldiniz!\n\n📧 Yeni email oluşturmak için /create yazın',
        'help': '🎭 **Yardım:**\n\n/create - Yeni email oluştur\n/check - Email kontrol et\n/inbox - Gelen kutuları göster\n/clear - Emails sil\n/domains - Domainleri göster\n/settings - Ayarlar',
        ...
        'checking_emails': '🔍 Emails kontrol ediliyor...',
        'deleting_email': '🗑️ Email siliniyor...'
    },
    'ru': {
        'name': 'ru',
        'display_name': 'Русский',
        'welcome': '🎭 **Fake Email Bot**\n\nДобро пожаловать в создатель 10-минутных фейковых email!\n\n📧 Напишите /create для создания нового email',
        'help': '🎭 **Помощь:**\n\n/create - Создать новый email\n/check - Проверить emails\n/inbox - Показать входящие\n/clear - Удалить emails\n/domains - Показать домены\n/settings - Настройки',
        'email_created': '✅ **Email Создан!**\n\n📧 Email: `{email}`\n⏰ Продолжительность: 10 минут\n\n📨 Напишите /check для получения emails',
        'no_emails': '📭 В вашем ящике нет emails',
        ...
        'checking_emails': '🔍 Проверка emails...',
