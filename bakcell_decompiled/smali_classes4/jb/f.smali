...
# static fields
.field public static volatile a:LLa/d;

.field public static volatile b:Ljb/q;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljb/f;->c:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Ljb/f;->d:Ljava/util/HashMap;
...
.method public static b(Landroid/content/Context;)LLa/d;
    .locals 3
    ...
    sget-object v2, Ljb/f;->a:LLa/d;

    if-nez v2, :cond_0

    sget-object v0, LLa/d;->f:LH/f;

    const/4 v2, 0x0

    sget-object v2, Le4/AzUj/CrafswijFlV;->aCFZNwoQPXGokOW:Ljava/lang/String;

    invoke-static {p0, v0, v2}, LLa/d;->c(Landroid/content/Context;LH/f;Ljava/lang/String;)LLa/d;

    move-result-object p0

    sput-object p0, Ljb/f;->a:LLa/d;
...
.method public static c(Landroid/content/Context;)Ljb/q;
    .locals 2

    sget-object v0, Ljb/f;->b:Ljb/q;
    ...
    invoke-virtual {p0, v0}, LLa/d;->b(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object p0

    invoke-static {p0}, Ljb/p;->asInterface(Landroid/os/IBinder;)Ljb/q;

    move-result-object p0

    sput-object p0, Ljb/f;->b:Ljb/q;
    :try_end_1
