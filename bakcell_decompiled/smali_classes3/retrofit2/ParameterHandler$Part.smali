...
# direct methods
.method public constructor <init>(Ljava/lang/reflect/Method;ILAe/s;Lretrofit2/Converter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lretrofit2/ParameterHandler$Part;->headers:LAe/s;
...
.method public apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    iget-object p2, p0, Lretrofit2/ParameterHandler$Part;->headers:LAe/s;

    invoke-virtual {p1, p2, v0}, Lretrofit2/RequestBuilder;->addPart(LAe/s;LAe/J;)V
