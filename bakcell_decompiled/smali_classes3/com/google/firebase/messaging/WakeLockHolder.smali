...
.field private static wakeLock:Lib/a;
...
.method public static synthetic a(Landroid/content/Intent;Lkb/l;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/messaging/WakeLockHolder;->lambda$sendWakefulServiceIntent$0(Landroid/content/Intent;Lkb/l;)V
...
.method public static acquireWakeLock(Landroid/content/Intent;J)V
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lib/a;
    ...
    sget-object p0, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lib/a;

    invoke-virtual {p0, p1, p2}, Lib/a;->a(J)V
...
.method private static checkAndInitWakeLock(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lib/a;

    if-nez v0, :cond_0

    new-instance v0, Lib/a;

    invoke-direct {v0, p0}, Lib/a;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lib/a;
...
.method private static synthetic lambda$sendWakefulServiceIntent$0(Landroid/content/Intent;Lkb/l;)V
    .locals 0
...
.method public static reset()V
    ...
    :try_start_0
    sput-object v1, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lib/a;
...
.method public static sendWakefulServiceIntent(Landroid/content/Context;Lcom/google/firebase/messaging/WithinAppServiceConnection;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v1, v2}, Lib/a;->a(J)V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p1, p2}, Lcom/google/firebase/messaging/WithinAppServiceConnection;->sendIntent(Landroid/content/Intent;)Lkb/l;
    ...
    invoke-direct {p1, v1, p2}, Lcom/google/firebase/messaging/k;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p0, p1}, Lkb/l;->c(Lkb/f;)Lkb/u;
...
.method public static startWakefulService(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    sget-object p1, Lcom/google/firebase/messaging/WakeLockHolder;->wakeLock:Lib/a;

    sget-wide v1, Lcom/google/firebase/messaging/WakeLockHolder;->WAKE_LOCK_ACQUIRE_TIMEOUT_MILLIS:J

    invoke-virtual {p1, v1, v2}, Lib/a;->a(J)V
