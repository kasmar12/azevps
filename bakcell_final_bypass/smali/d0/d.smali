...
.method public final a(Landroid/util/Size;ILandroid/graphics/Rect;)V
    ...
    iget-object v2, p0, Ld0/d;->d:Landroid/graphics/Matrix;

    invoke-direct {v1, v2}, Landroid/graphics/Matrix;-><init>(Landroid/graphics/Matrix;)V

    invoke-virtual {p0, p1, p2}, Ld0/d;->c(Landroid/util/Size;I)Landroid/graphics/Matrix;
...
.method public final b()Landroid/util/Size;
    ...
    iget-object v1, p0, Ld0/d;->b:Landroid/graphics/Rect;

    invoke-virtual {v1}, Landroid/graphics/Rect;->height()I

    move-result v1

    iget-object v2, p0, Ld0/d;->b:Landroid/graphics/Rect;
...
.method public final c(Landroid/util/Size;I)Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0}, Ld0/d;->b()Landroid/util/Size;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {p1, v1, v0}, LH/r;->d(Landroid/util/Size;ZLandroid/util/Size;)Z
    ...
    iget-object v3, p0, Ld0/d;->h:Ld0/h;
    ...
    invoke-static {v6, v5}, LVa/f0;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    sget-object v6, Ld0/h;->d:Ld0/h;

    if-eq v3, v6, :cond_5

    sget-object v6, Ld0/h;->c:Ld0/h;

    if-eq v3, v6, :cond_5

    sget-object v6, Ld0/h;->e:Ld0/h;
    ...
    iget-object v0, p0, Ld0/d;->b:Landroid/graphics/Rect;
    ...
    invoke-static {p1, p2, v0, v1}, LH/r;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;

    move-result-object p1

    iget-boolean p2, p0, Ld0/d;->f:Z

    if-eqz p2, :cond_8

    iget-boolean p2, p0, Ld0/d;->g:Z

    if-eqz p2, :cond_8

    iget p2, p0, Ld0/d;->c:I

    invoke-static {p2}, LH/r;->c(I)Z
    ...
    iget-object p2, p0, Ld0/d;->b:Landroid/graphics/Rect;
...
.method public final d()Landroid/graphics/Matrix;
    ...
    iget-object v1, p0, Ld0/d;->a:Landroid/util/Size;
    ...
    iget-object v2, p0, Ld0/d;->a:Landroid/util/Size;
    ...
    :cond_0
    iget v1, p0, Ld0/d;->e:I

    invoke-static {v1}, LVa/O3;->b(I)I
    ...
    invoke-static {v0, v0, v1, v2}, LH/r;->a(Landroid/graphics/RectF;Landroid/graphics/RectF;IZ)Landroid/graphics/Matrix;
...
.method public final e(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    iget-object v0, p0, Ld0/d;->a:Landroid/util/Size;
...
.method public final f()Z
    ...
    :goto_1
    iget-object v3, p0, Ld0/d;->b:Landroid/graphics/Rect;

    if-eqz v3, :cond_2

    iget-object v3, p0, Ld0/d;->a:Landroid/util/Size;
