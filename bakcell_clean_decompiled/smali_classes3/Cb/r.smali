...
.method public final a(Landroid/graphics/Canvas;Landroid/graphics/Rect;FZZ)V
    ...
    iput v0, p0, LCb/r;->b:F

    iget-object v0, p0, LCb/o;->a:LCb/e;

    move-object v1, v0

    check-cast v1, LCb/v;

    iget v1, v1, LCb/e;->a:I
    ...
    iget p1, v0, LCb/e;->f:I

    if-ne p1, p2, :cond_8

    iput p3, p0, LCb/r;->f:F

    goto :goto_1

    :cond_8
    iput v5, p0, LCb/r;->f:F
...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Paint;II)V
    ...
    invoke-static {p3, p4}, LWa/A4;->a(II)I

    move-result p3

    iget-object p4, p0, LCb/o;->a:LCb/e;

    check-cast p4, LCb/v;

    iget v0, p4, LCb/v;->k:I
    ...
    iget p3, p0, LCb/r;->b:F

    const/high16 v0, 0x40000000    # 2.0f

    div-float/2addr p3, v0

    iget v1, p0, LCb/r;->c:F
    ...
    invoke-virtual/range {v1 .. v7}, LCb/r;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V

    :cond_0
    return-void
.end method

.method public final c(Landroid/graphics/Canvas;Landroid/graphics/Paint;LCb/n;I)V
    .locals 9

    iget v0, p3, LCb/n;->c:I

    invoke-static {v0, p4}, LWa/A4;->a(II)I

    move-result v6

    iget v4, p3, LCb/n;->a:F

    iget v5, p3, LCb/n;->b:F

    iget v8, p3, LCb/n;->d:I
    ...
    invoke-virtual/range {v1 .. v8}, LCb/r;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p5, p6}, LWa/A4;->a(II)I
    ...
    invoke-virtual/range {v0 .. v7}, LCb/r;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {v1, v9, v0}, LVa/o0;->a(FFF)F

    move-result v1

    move/from16 v2, p4

    invoke-static {v2, v9, v0}, LVa/o0;->a(FFF)F

    move-result v2

    iget v3, v7, LCb/r;->f:F

    sub-float v3, v0, v3

    invoke-static {v3, v0, v1}, LIe/d;->b(FFF)F
    ...
    invoke-static {v3, v0, v2}, LIe/d;->b(FFF)F
    ...
    invoke-static {v1, v9, v4}, LVa/o0;->a(FFF)F
    ...
    invoke-static {v2, v6, v0}, LVa/o0;->a(FFF)F
    ...
    invoke-virtual/range {v0 .. v6}, LCb/r;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V
