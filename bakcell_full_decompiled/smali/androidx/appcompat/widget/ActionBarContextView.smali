...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p0, v1, LP8/o;->c:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-boolean v2, v1, LP8/o;->a:Z

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->a:LP8/o;
...
.method public final c(Ln/a;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->n0:Landroid/view/View;
    ...
    invoke-direct {v2, v3, p1}, Landroidx/appcompat/app/a;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Ln/a;->c()Lo/j;
    ...
    iput-boolean v2, v0, Landroidx/appcompat/widget/l;->m0:Z

    iput-boolean v2, v0, Landroidx/appcompat/widget/l;->n0:Z
    ...
    invoke-virtual {p1, v3, v4}, Lo/j;->b(Lo/v;Landroid/content/Context;)V

    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->d:Landroidx/appcompat/widget/l;

    iget-object v3, p1, Landroidx/appcompat/widget/l;->Y:Lo/x;

    if-nez v3, :cond_3

    iget-object v4, p1, Landroidx/appcompat/widget/l;->d:Landroid/view/LayoutInflater;

    iget v5, p1, Landroidx/appcompat/widget/l;->f:I
    ...
    iput-object v1, p1, Landroidx/appcompat/widget/l;->Y:Lo/x;

    iget-object v4, p1, Landroidx/appcompat/widget/l;->c:Lo/j;

    invoke-interface {v1, v4}, Lo/x;->c(Lo/j;)V

    invoke-virtual {p1, v2}, Landroidx/appcompat/widget/l;->e(Z)V

    :cond_3
    iget-object v1, p1, Landroidx/appcompat/widget/l;->Y:Lo/x;
...
.method public final d()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->q0:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->q0:Landroid/widget/LinearLayout;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->l0:Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->s0:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->q0:Landroid/widget/LinearLayout;
...
.method public getAnimatedVisibility()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->f:LL0/W;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->a:LP8/o;

    iget v0, v0, LP8/o;->b:I
...
.method public final i(IJ)LL0/W;
    .locals 3
    ...
    invoke-virtual {v1, p2, p3}, LL0/W;->c(J)V

    iget-object p2, v0, LP8/o;->c:Ljava/lang/Object;

    check-cast p2, Landroidx/appcompat/widget/ActionBarContextView;

    iput-object v1, p2, Landroidx/appcompat/widget/ActionBarContextView;->f:LL0/W;

    iput p1, v0, LP8/o;->b:I
    ...
    invoke-virtual {v2, v1}, LL0/W;->a(F)V

    invoke-virtual {v2, p2, p3}, LL0/W;->c(J)V

    iget-object p2, v0, LP8/o;->c:Ljava/lang/Object;

    check-cast p2, Landroidx/appcompat/widget/ActionBarContextView;

    iput-object v2, p2, Landroidx/appcompat/widget/ActionBarContextView;->f:LL0/W;

    iput p1, v0, LP8/o;->b:I

    invoke-virtual {v2, v0}, LL0/W;->d(LL0/X;)V
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p1, Landroidx/appcompat/widget/l;->b:Landroid/content/Context;
    ...
    :goto_2
    iput v0, p1, Landroidx/appcompat/widget/l;->q0:I
...
.method public final onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->k0:Z

    :cond_0
    iget-boolean v3, p0, Landroidx/appcompat/widget/ActionBarContextView;->k0:Z
    ...
    iput-boolean v4, p0, Landroidx/appcompat/widget/ActionBarContextView;->k0:Z
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p3, p0, Landroidx/appcompat/widget/ActionBarContextView;->n0:Landroid/view/View;
    ...
    :goto_4
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarContextView;->n0:Landroid/view/View;
    ...
    :cond_6
    :goto_6
    iget-object p3, p0, Landroidx/appcompat/widget/ActionBarContextView;->q0:Landroid/widget/LinearLayout;
...
.method public final onMeasure(II)V
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarContextView;->n0:Landroid/view/View;
    ...
    :cond_2
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarContextView;->q0:Landroid/widget/LinearLayout;

    const/4 v7, 0x0

    if-eqz v6, :cond_7

    iget-object v8, p0, Landroidx/appcompat/widget/ActionBarContextView;->p0:Landroid/view/View;

    if-nez v8, :cond_7

    iget-boolean v8, p0, Landroidx/appcompat/widget/ActionBarContextView;->v0:Z
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/ActionBarContextView;->q0:Landroid/widget/LinearLayout;

    invoke-virtual {v8, v6, v5}, Landroid/view/View;->measure(II)V

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarContextView;->q0:Landroid/widget/LinearLayout;
    ...
    :cond_7
    :goto_3
    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarContextView;->p0:Landroid/view/View;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-boolean v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->j0:Z
    ...
    iput-boolean v3, p0, Landroidx/appcompat/widget/ActionBarContextView;->j0:Z
...
.method public setCustomView(Landroid/view/View;)V
    ...
    :cond_0
    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->p0:Landroid/view/View;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p0, p1}, LL0/T;->n(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public setTitleOptional(Z)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->v0:Z
    ...
    :cond_0
    iput-boolean p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->v0:Z
